...
<body>
	...
	<form action="updateBusConfirmation.jsp" method="get">
	<div class="container">
		<table>
		<tr id="heading">
			<td>Bus Id</td>
		...
		<tr>
			<td><input type="text" name="updatebus_id"></td>
			<td><input type="text" name="updatebus_source"></td>
			<td><input type="text" name="updatebus_destination"></td>
			<td><input type="text" name="updatebus_time"></td>
			<td><input type="text" name="updatebus_no"></td>
			<td><input type="text" name="updatebus_price"></td>
		</tr>
		<br>
		<input type="submit" value="Update Bus" class="btn btn-lg btn-primary">
